...
class Array123Test {
    ...
    @Test
    void shouldReturnFalse_WhenArrayIsNull() {
    ...
    @Test
    void shouldReturnFalse_WhenArrayLengthIsLessThan3() {
    ...
    @Test
    void shouldReturnTrue_WhenArrayLengthIs3And123InSequence() {
    ...
    @Test
    void shouldReturnFalse_WhenArrayLengthIs3And123NotInSequence() {
    ...
    @Test
    void shouldReturnFalse_WhenArrayLengthIs3And123DoesntExist() {
    ...
    @Test
    void shouldReturnFalse_WhenArrayLengthIsGreaterThan3And123DoesntExist() {
    ...
    @Test
    void shouldReturnFalse_WhenArrayLengthIsGreaterThan3And123NotInSequence() {
    ...
    @Test
    void shouldReturnTrue_WhenArrayLengthIsGreaterThan3And123InSequence() {
