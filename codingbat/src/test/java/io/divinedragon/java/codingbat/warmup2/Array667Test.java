...
class Array667Test {
    ...
    @Test
    void shouldReturn0_WhenArrayIsNull() {
    ...
    @Test
    void shouldReturn0_WhenArrayIsSingleElement() {
    ...
    @Test
    void shouldReturn0_WhenArrayIsDoubleElementAndNotMatching() {
    ...
    @Test
    void shouldReturn0_WhenArrayIsDoubleElementAndMatching() {
    ...
    @Test
    void shouldReturn0_WhenArrayIsMultiElementAndNotMatching() {
    ...
    @Test
    void shouldReturn0_WhenArrayIsMultiElementAndMatching() {
