...
class ArrayFront9Test {
    ...
    @Test
    void shouldReturnFalse_WhenArrayLengthIsLessThanEqualTo4AndHasNo9() {
    ...
    @Test
    void shouldReturnTrue_WhenArrayLengthIsLessThanEqualTo4AndA9() {
    ...
    @Test
    void shouldReturnFalse_WhenArrayLengthIsGreaterThan5AndNo9() {
    ...
    @Test
    void shouldReturnFalse_WhenArrayLengthIsGreaterThan5AndHas9AfterPosition4() {
    ...
    @Test
    void shouldReturnTrue_WhenArrayLengthIsGreaterThan5AndHas9BeforePosition4() {
